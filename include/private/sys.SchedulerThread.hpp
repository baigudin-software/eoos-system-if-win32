/**
 * @brief Thread class of this scheduler.
 *
...
private:
    ...
    /**
     * @brief The semaphore gives the started thread main method to start user task main method.
     */
    Semaphore sem_;
    ...
    /**
     * @brief Current identifier is a resource of porting OS process.
     */
    int32_t res_;
